...
async def admin_update_notification(bot: AsyncTeleBot, user_id: int, old_username: str | None, new_username: str | None) -> None:
...
async def admin_censorship_violation(bot: AsyncTeleBot, text_br: str, sender_id: int, sender_username: str | None, content_type: str) -> None:
...
async def return_admin_notify(bot: AsyncTeleBot, user_id: int, owner_id: int) -> None:
...
async def add_admin_notify(bot: AsyncTeleBot, owner_id: int, user_id: int) -> None:
...
async def remove_admin_notify(bot: AsyncTeleBot, owner_id: int, user_id: int) -> None:
...
async def all_admin_notify(bot: AsyncTeleBot, text: str) -> None:
...
async def new_ticket_notify(bot: AsyncTeleBot, id_ticket: int, user_id: int, type_ticket: str) -> None:
...
async def new_message_in_ticket_notify(bot: AsyncTeleBot, id_ticket: int, type_ticket: str) -> None:
